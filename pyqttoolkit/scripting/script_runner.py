...
class ScriptRunner:    
    ...
    def run(self, script, context):
        ...
        exec(code, {'__builtins__': {**__builtins__, '__import__': self._import, 'print': context.add_output, **{g: self._not_implemented for g in self._disallowed_globals}}}, context.locals)
