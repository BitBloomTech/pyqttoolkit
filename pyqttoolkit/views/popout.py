...
class PopoutWidget(QWidget):
    def __init__(self, parent, content, background_color, foreground_color):
...
QLabel {{
    color: {foreground_color}
        ...
        self.setStyleSheet(stylesheet.format(background_color=format_color(background_color, opacity=0.8), foreground_color=format_color(foreground_color)))
